...
const ErrorApps = () => {
    ...
    <img className='w-64 md:w-80 my-4' src={errorAppImg} alt='No apps' />
    ...
    <a href='/' className='btn inline-block px-8 py-2 bg-gradient-to-r from-[#632EE3] to-[#9F62F2] hover:bg-purple-600 text-white font-medium rounded-md transition-colors cursor-pointer'>
      Go Back!
    </a>
