...
const Navbar = () => {
  ...
  <div className="navbar-center hidden md:flex">
    <ul className="menu menu-horizontal px-1 font-semibold">
      <li>
        <NavLink to="/" className={({isActive}) => isActive ? "text-purple-600 underline" : "text-black"}>
          Home
        </NavLink>
      </li>
        <li>
             <NavLink to="/applications" className={({isActive}) => isActive ? "text-purple-600 underline" : "text-black"}>
          Apps
        </NavLink>
        </li>
        <li>
            <NavLink to="/installed" className={({isActive}) => isActive ? "text-purple-600 underline" : "text-black"}>
         Installation
        </NavLink>
        </li>
    </ul>
  ...
  <div className="navbar-end">
    ...
    <a href='https://github.com/hasan8651' className="btn bg-purple-600 text-white px-4 py-2 rounded-md">
